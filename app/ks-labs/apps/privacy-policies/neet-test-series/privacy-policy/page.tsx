      ...
      <div className="mx-auto max-w-3xl px-6 py-12">
        <header className="mb-10 border-b border-gray-800 pb-8">
          ...
          <p className="mt-3 text-sm text-gray-400">
            Effective Date:{" "}
            <span className="font-semibold">January 9, 2026</span>
          </p>
        </header>
        ...
        <div className="space-y-10 text-gray-300">
          ...
          <section>
            ...
            <div className="pl-11">
              <p>
                MongoDB provides database storage functionality for the Neet Test
                Series app. Your personal information (name and email) is securely
                stored in our MongoDB database. We encourage you to review
                MongoDB&apos;s privacy policy independently to understand how they
                handle data.
              </p>
